/* Easing Equations
 * Created from Robert Penners easing code from the interwebs
 */
...
public class EasingEquations {
    ...
    public static void TweenVector3(ref Vector3 tweenValue, float t, ref Vector3 b , ref Vector3 c, float d, Ease Ease)
    {
        float x = 0;
        float y = 0;
        float z = 0;
        ...
        tweenValue.Set(x, y, z);
    }

    public static float TweenFloat(float t , float b , float c , float d , Ease Ease)
    {
        float tweenValue = 0;

        if(Ease == Ease.Linear)
            tweenValue = EaseNone (t , b , c , d);
        else if(Ease == Ease.EaseInQuad)
            tweenValue = EaseInQuad (t , b , c , d);
        else if(Ease == Ease.EaseOutQuad)
            tweenValue = EaseOutQuad (t , b , c , d);
        else if(Ease == Ease.EaseInOutQuad)
            tweenValue = EaseInOutQuad (t , b , c , d);
        else if(Ease == Ease.EaseOutInQuad)
            tweenValue = EaseOutInQuad (t , b , c , d);
        else if(Ease == Ease.EaseInCubic)
            tweenValue = EaseInCubic (t , b , c , d);
        else if(Ease == Ease.EaseOutCubic)
            tweenValue = EaseOutCubic (t , b , c , d);
        else if(Ease == Ease.EaseInOutCubic)
            tweenValue = EaseInOutCubic (t , b , c , d);
        else if(Ease == Ease.EaseOutInCubic)
            tweenValue = EaseOutInCubic (t , b , c , d);
        else if(Ease == Ease.EaseInQuart)
            tweenValue = EaseInQuart (t , b , c , d);
        else if(Ease == Ease.EaseOutQuart)
            tweenValue = EaseOutQuart (t , b , c , d);
        else if(Ease == Ease.EaseInOutQuart)
            tweenValue = EaseInOutQuart (t , b , c , d);
        else if(Ease == Ease.EaseOutInQuart)
            tweenValue = EaseOutInQuart (t , b , c , d);
        else if(Ease == Ease.EaseInQuint)
            tweenValue = EaseInQuint (t , b , c , d);
        else if(Ease == Ease.EaseOutQuint)
            tweenValue = EaseOutQuint (t , b , c , d);
        else if(Ease == Ease.EaseInOutQuint)
            tweenValue = EaseInOutQuint (t , b , c , d);
        else if(Ease == Ease.EaseOutInQuint)
            tweenValue = EaseOutInQuint (t , b , c , d);
        else if(Ease == Ease.EaseInSine)
            tweenValue = EaseInSine (t , b , c , d);
        else if(Ease == Ease.EaseOutSine)
            tweenValue = EaseOutSine (t , b , c , d);
        else if(Ease == Ease.EaseInOutSine)
            tweenValue = EaseInOutSine (t , b , c , d);
        else if(Ease == Ease.EaseOutInSine)
            tweenValue = EaseOutInSine (t , b , c , d);
        else if(Ease == Ease.EaseInExpo)
            tweenValue = EaseInExpo (t , b , c , d);
        else if(Ease == Ease.EaseOutExpo)
            tweenValue = EaseOutExpo (t , b , c , d);
        else if(Ease == Ease.EaseInOutExpo)
            tweenValue = EaseInOutExpo (t , b , c , d);
        else if(Ease == Ease.EaseOutInExpo)
            tweenValue = EaseOutInExpo (t , b , c , d);
        else if(Ease == Ease.EaseInCirc)
            tweenValue = EaseInCirc (t , b , c , d);
        else if(Ease == Ease.EaseOutCirc)
            tweenValue = EaseOutCirc (t , b , c , d);
        else if(Ease == Ease.EaseInOutCirc)
            tweenValue = EaseInOutCirc (t , b , c , d);
        else if(Ease == Ease.EaseOutInCirc)
            tweenValue = EaseOutInCirc (t , b , c , d);
        else if(Ease == Ease.EaseInElastic)
            tweenValue = EaseInElastic (t , b , c , d);
        else if(Ease == Ease.EaseOutElastic)
            tweenValue = EaseOutElastic (t , b , c , d);
        else if(Ease == Ease.EaseInOutElastic)
            tweenValue = EaseInOutElastic (t , b , c , d);
        else if(Ease == Ease.EaseOutInElastic)
            tweenValue = EaseOutInElastic (t , b , c , d);
        else if(Ease == Ease.EaseInBack)
            tweenValue = EaseInBack (t , b , c , d);
        else if(Ease == Ease.EaseOutBack)
            tweenValue = EaseOutBack (t , b , c , d);
        else if(Ease == Ease.EaseInOutBack)
            tweenValue = EaseInOutBack (t , b , c , d);
        else if(Ease == Ease.EaseOutInBack)
            tweenValue = EaseOutInBack (t , b , c , d);
        else if(Ease == Ease.EaseInBounce)
            tweenValue = EaseInBounce (t , b , c , d);
        else if(Ease == Ease.EaseOutBounce)
            tweenValue = EaseOutBounce (t , b , c , d);
        else if(Ease == Ease.EaseInOutBounce)
            tweenValue = EaseInOutBounce (t , b , c , d);
        else if(Ease == Ease.EaseOutInBounce)
            tweenValue = EaseOutInBounce (t , b , c , d);
